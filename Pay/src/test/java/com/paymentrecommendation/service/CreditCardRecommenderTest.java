...
import com.paymentrecommendation.models.cart.CartDetail;
import com.paymentrecommendation.models.cart.CartItem;
...
import com.paymentrecommendation.models.user.UserContext;
import com.paymentrecommendation.models.user.UserPaymentInstrument;
...
class CreditCardRecommenderTest {
    ...
    void testLineOfBusinessNotSupported() {
        ...
        assertEquals("java.lang.Exception: The line of business is not supported", ex.getMessage());
    }
